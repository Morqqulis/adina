(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".houses__slider")) new swiper_core_Swiper(".houses__slider", {
    ...
    headerLinks.forEach(link => {
        if (window.location.pathname.includes(link.href.split("/").pop())) link.classList.add("header__link_active");
    });
    window["FLS"] = true;
    isWebp();
    spollers();
